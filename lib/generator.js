...
const templates = {
  ...
  product_description: {
    professional: [
      "Premium {{product}} designed specifically for {{audience}}. Quality you can trust.",
      "Introducing {{product}} — the professional choice for {{audience}}.",
      "Experience the difference with {{product}}. Engineered for {{audience}}.",
      "{{product}}: Where quality meets value. Perfect for {{audience}}.",
      "Elevate your standards with {{product}}. Made for {{audience}}.",
      "The {{product}} difference: superior quality, unbeatable value.",
      "Discover why {{audience}} choose {{product}} for their needs.",
      "{{product}} — thoughtfully designed, meticulously crafted.",
      "Your search for the perfect {{product}} ends here.",
      "The gold standard in {{product}} for {{audience}}."
    ],
    casual: [
      "Meet {{product}} — your new favorite thing. Trust us, you'll love it.",
      "Hey {{audience}}, we made something just for you. It's called {{product}}.",
      "You know what's awesome? {{product}}. Seriously, check it out.",
      "Finally, a {{product}} that actually delivers on its promises.",
      "Life's too short for mediocre {{product}}. Try the best.",
      "We tried making {{product}} perfect. We think we nailed it.",
      "Spoiler alert: {{product}} is amazing. You're welcome.",
      "The {{product}} everyone's talking about. See what the hype is about.",
      "Just a friendly reminder that {{product}} exists and it's incredible.",
      "Your daily life needs {{product}}. Trust us on this one."
    ],
    urgent: [
      "Limited Time: Get {{product}} Before It's Gone!",
      "Hurry! {{product}} Discount Ends Soon.",
      "Only a few {{product}} left in stock. Order now!",
      "Flash Sale: {{product}} at the Best Price Ever!",
      "Don't Miss Out on {{product}} — Offer Expires Today.",
      "Last Chance to Grab {{product}} at This Price.",
      "Act Fast: {{product}} Selling Out Quickly.",
      "Exclusive Offer on {{product}} for {{audience}} — Today Only.",
      "Your {{product}} Deal is About to Expire. Don't Wait!",
      "Immediate Delivery Available for {{product}}. Order Now."
    ],
    humorous: [
      "{{product}} — because your current solution is probably fine, but this is better.",
      "If {{product}} were a person, we'd give it a raise. It's that good.",
      "Warning: {{product}} may cause excessive satisfaction and mild jealousy.",
      "Our competitors hate {{product}}. You'll love it.",
      "{{product}}: It's like magic, but we actually explain how it works.",
      "Yes, {{product}} really is this good. No, we're not kidding.",
      "You had us at 'hello.' But {{product}} had us at 'wow.'",
      "{{product}} — the only thing getting between you and total satisfaction.",
      "We put the 'pro' in {{product}}. Actually, we put the 'fun' too.",
      "Stop everything. {{product}} just made everything better."
    ],
    inspirational: [
      "Transform your everyday with {{product}}. You deserve it.",
      "Believe in better. Choose {{product}}.",
      "Your journey to excellence starts with {{product}}.",
      "Empower your life with {{product}} — because you're worth it.",
      "The best version of your day begins with {{product}}.",
      "Dream it. Achieve it. {{product}} helps you get there.",
      "Small changes, big impact. Start with {{product}}.",
      "Rise to the occasion with {{product}} by your side.",
      "Unlock your full potential with {{product}}.",
      "Make today extraordinary with {{product}}."
    ]
  },
  email_campaign: {
    professional: [
