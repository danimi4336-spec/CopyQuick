...
console.log('📋 Passport GoogleStrategy initialized with:');
console.log(`  clientID:     ${googleClientID ? googleClientID.substring(0, 20) + '...' : 'EMPTY'}`);
console.log(`  clientSecret: ${googleClientSecret ? googleClientSecret.substring(0, 8) + '...' : 'EMPTY'}`);
