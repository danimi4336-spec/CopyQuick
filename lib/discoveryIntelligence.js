const DOMAIN_DEFINITIONS = [
  { name: 'Product', importance: 100, fields: ['businessType', 'industry', 'category'], questionId: 'business_type' },
  { name: 'Customer', importance: 100, fields: ['targetAudience'], questionId: 'target_audience' },
  { name: 'Value Proposition', importance: 95, fields: ['customerMotivation'], questionId: 'customer_motivation' },
  { name: 'Sales Channel', importance: 90, fields: ['salesChannel'], questionId: 'sales_channel' },
  { name: 'Competitive Positioning', importance: 90, fields: ['competitiveDifferentiation'], questionId: 'competitive_differentiation' },
  { name: 'Launch Stage', importance: 80, fields: ['launchStage'], questionId: 'launch_stage' },
  { name: 'Brand', importance: 60, fields: ['brand'], questionId: 'brand' },
  { name: 'Budget', importance: 40, fields: ['budget'], questionId: 'budget' },
  { name: 'Timeline', importance: 30, fields: ['timeline'], questionId: 'timeline' }
];
